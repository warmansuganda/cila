        ...
        <div class="box box-widget">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="checkbox" value="1" {{ $data['is_admin'] ? 'checked' : '' }} name="is_admin" data-on-text="Ya" data-off-text="Bukan">
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-2 control-label"> Deskripsi</label>
              <div class="col-sm-8">
                {{ form_textarea('description', $data['description'], ['class' => 'form-control', 'style' => 'height: 100px;']) }}
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-2 control-label"> Status</label>
              <div class="col-sm-5">
                <input type="checkbox" value="1" {{ $data['status'] ? 'checked' : '' }}  name="status" data-on-text="Aktif" data-off-text="Tidak Aktif">
              </div>
            </div>
