...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ base_url() }}/resources/css/default.custome.css">
    <link rel="stylesheet" type="text/css" href="{{ base_url() }}/resources/css/login.custome.css">
...
<body id="login">
    <div class="row" id="header">
        <div class="col col-md-6 col-sm-6 col-xs-6">
            <img class="logo" src="{{ base_url() }}resources/img/logo_bijb_120.png">
        </div>
    ...
    <div class="row">
        <div class="col col-md-8 col-sm-6">
            <img class="img-responsive" src="{{ base_url() }}resources/img/scetch_bijb.jpg">
            <div class="apps-information">
                ...
                <button type="button" class="btn">User Manual</button>
            </div>
        </div>
